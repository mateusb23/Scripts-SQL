...
INSERT INTO conta(NOME_PESSOA,TIPO_CONTA,BANCO_NOME) VALUES('Ronaldo','corrente','');
...
UPDATE BANCO
SET NOME_BANCO = 'Safra Bank',
CNPJ_BANCO = '9123495034299'
WHERE ID_BANCO = 1;
...
DELETE FROM PESSOA
WHERE NOME_PESSOA IN ('Sauron', 'Gilbert');
...
ALTER TABLE tb_cidades ADD CONSTRAINTS ID_ESTADO_FK FOREIGN KEY(id_estado) references tb_estados(id_estado);
...
INSERT INTO tb_cidades  VALUES (7971, 23
, 'RS', 'Silveira');
...
SELECT TB_ESTADOS.NOME AS NOME_ESTADOS, TB_CIDADES.NOME AS NOME_CIDADES, TB_CIDADES.UF FROM TB_CIDADES
INNER JOIN TB_ESTADOS ON TB_ESTADOS.ID_ESTADO = TB_CIDADES.ID_ESTADO
WHERE TB_ESTADOS.UF = 'PE';
